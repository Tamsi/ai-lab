...
Courses I want to follow. Add a note file in `notes/courses/` when I start one.

| Status | Course | Link | My notes |
|---|---|---|---|
...
| [ ] | NVIDIA — Intro to CUDA | https://developer.nvidia.com/blog/even-easier-introduction-cuda/ | |
| [ ] | NVIDIA — CUDA Programming Guide | https://docs.nvidia.com/cuda/cuda-programming-guide/index.html | |
| [ ] | NVIDIA — CUDA exercises (PDF) | https://www.nvidia.com/content/cudazone/download/Exercise_Instructions.pdf | |
| [ ] | Udacity — Agentic AI | https://www.udacity.com/course/agentic-ai--nd900 | |

**Status:** `[ ]` not started · `[~]` in progress · `[x]` done

Create notes: `notes/courses/3blue1brown-linear-algebra.md`
